function(protobuf_generate)
  ...
  foreach(_proto ${protobuf_generate_PROTOS})
    ...
    # find_program(_gRPC_PROTOBUF_PROTOC_EXECUTABLE protoc PATHS /root/protobuf-test/build/third_party/protobuf)
    ...
    add_custom_command(
      ...
      DEPENDS ${_abs_file} ${protobuf_PROTOC_EXE} ${protobuf_generate_DEPENDENCIES} protobuf::protoc
      COMMENT ${_comment}
      VERBATIM )
  endforeach()
