...
MyQuicEpollClientFactory::MyQuicEpollClientFactory()
    : event_loop_(GetDefaultEventLoop()->Create(QuicDefaultClock::Get())) {}

std::unique_ptr<QuicSpdyClientBase> MyQuicEpollClientFactory::CreateClient(
  ...
  return std::make_unique<MyQuicClient>(
